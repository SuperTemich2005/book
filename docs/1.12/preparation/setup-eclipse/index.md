...
Теперь необходимо выполнить команду `gradlew eclipse`. Это может занять у Вас очень много времени. Если у вас Windows, то вы можете кликнуть правой кнопкой
